...
# dropout. Not the ablation once planned to pick this value (TODO.md Future experiments): a
# settled call, since a 24-25 dim target does not need masking's co-adaptation guard the way
# osmordred's 3585 does
